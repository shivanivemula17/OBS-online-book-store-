...
def dictionary_languages(request):
...
def art_photography(request):
    art_photography_books = books.objects.filter(CategoryName="art_&_photography")
...
def biographies_memories(request):
    biographies_memories_books = books.objects.filter(CategoryName="biographies_&_memoirs")
...
def dictionary_languages(request):
    dictionary_languages_books = books.objects.filter(CategoryName="dictionaries_&_language")
