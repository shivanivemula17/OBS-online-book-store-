...
urlpatterns = [
    ...
    path('',h1.homepage, name='home'),
    path('about_us/',h1.aboutus, name='about_us' ),
    ...
    path('contact/',h1.contactus, name='contact'),
    path('Dictionaries_&_Language/',h1.dictionary_languages, name='Dictionaries_&_Language'),
    ...
    path('request_a_book/',h1.request_book, name='request_a_book'),
